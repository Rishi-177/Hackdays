...
from models.api_models import DashboardResponse, SavingsMetrics
from db.repository import get_latest_execution_plan_by_workflow, get_executions_by_workflow, get_workflow, DEMO_WORKFLOW
...
def get_dashboard_metrics(workflow_id: str):
    ...
    if not latest_plan:
        opt_res = optimize_workflow(workflow_dag=wf.get("dag"))
